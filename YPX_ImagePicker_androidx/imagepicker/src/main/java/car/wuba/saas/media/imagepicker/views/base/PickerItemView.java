package car.wuba.saas.media.imagepicker.views.base;
...
public abstract class PickerItemView extends PBaseLayout {
     ...
     * @param presenter    implements of {@link car.wuba.saas.media.imagepicker.presenter.IPickerPresenter}
     * @return 拍照
     */
     ...
     *
     * @param imageItem   当前图片
     * @param disableCode 不能选中的原因 {@link car.wuba.saas.media.imagepicker.bean.PickerItemDisableCode}
     */
