...
import car.wuba.saas.media.imagepicker.bean.ImageSet;
...
import static car.wuba.saas.media.imagepicker.data.MediaStoreConstants.BUCKET_ORDER_BY;
import static car.wuba.saas.media.imagepicker.data.MediaStoreConstants.COLUMN_BUCKET_ID;
import static car.wuba.saas.media.imagepicker.data.MediaStoreConstants.COLUMN_BUCKET_DISPLAY_NAME;
import static car.wuba.saas.media.imagepicker.data.MediaStoreConstants.COLUMN_COUNT;
import static car.wuba.saas.media.imagepicker.data.MediaStoreConstants.COLUMN_URI;
import static car.wuba.saas.media.imagepicker.data.MediaStoreConstants.MEDIA_TYPE;
import static car.wuba.saas.media.imagepicker.data.MediaStoreConstants.MEDIA_TYPE_IMAGE;
import static car.wuba.saas.media.imagepicker.data.MediaStoreConstants.MEDIA_TYPE_VIDEO;
import static car.wuba.saas.media.imagepicker.data.MediaStoreConstants.MIME_TYPE;
import static car.wuba.saas.media.imagepicker.data.MediaStoreConstants.QUERY_URI;
import static car.wuba.saas.media.imagepicker.data.MediaStoreConstants.SIZE;
import static car.wuba.saas.media.imagepicker.data.MediaStoreConstants._ID;
